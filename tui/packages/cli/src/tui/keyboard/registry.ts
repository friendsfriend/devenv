...
const RAW_KEYBINDS: KeybindDef[] = [
	...
	{ keys: ["F"], description: "Filter tests", context: "testResults", category: "Actions" },
	{ keys: ["O"], description: "Order tests", context: "testResults", category: "Actions" },
	...
	{ keys: ["Shift+M"], description: "View references filtered to CRs", context: "issueDetail", category: "Actions" },
	{ keys: ["Shift+I"], description: "View references filtered to issues", context: "issueDetail", category: "Actions" },
	...
	{ keys: ["F"], description: "Filter references", context: "references", category: "Actions" },
	{ keys: ["O"], description: "Order references", context: "references", category: "Actions" },
...
const FOOTER_LABELS = new Map<string, string>([
	...
	["View references filtered to CRs", "CRs"],
	["View references filtered to issues", "Refs"],
