...
const FOOTER_LABELS = new Map<string, string>([
	...
	["Switch tab (Apps/Infra/Libs/Scripts)", "Tabs"],
	["Search table", "Search"],
	["Filter table", "Filter"],
	...
	["Refresh status (non-scripts tab)", "Refresh"],
	["Build application / toggle build logs while running", "Build"],
	["Test application / toggle test logs while running", "Test"],
	["Run script (with args if applicable)", "Run"],
	["Run script with args (scripts tab)", "Run args"],
	["Delete script/folder", "Delete"],
	["Refresh scripts", "Refresh"],
	["Open AI agent view", "AI"],
	["Open SSH host picker", "SSH"],
	["Copy selection to clipboard", "Copy"],
	["Quit application", "Quit"],
	["Navigate merge requests", "MRs"],
	["Go to first MR", "First MR"],
	["Go to last MR", "Last MR"],
	["View selected MR detail", "MR detail"],
	["Search merge requests", "Search MRs"],
	["Toggle MR state filter: opened/closed/all", "MR state"],
	["Previous page", "Prev page"],
	["Next page", "Next page"],
	["Back to table", "Back"],
	["Toggle approval (approve/unapprove)", "Approve"],
	["AI review — stream review, then post as comment", "AI review"],
	["Rebase merge request", "Rebase"],
