...
import type { MergeRequest, Job, TestSummary, MRChange, Discussion } from '@devenv/types';
...
export function MergeRequestDetailView(props: MergeRequestDetailViewProps) {
  ...
  const discussionCounts = createMemo(() => {
    ...
    const resolved = props.discussions.filter(d => d.notes[0]?.resolved).length;
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            <box style={{ flexDirection: 'row', paddingLeft: 1, paddingRight: 1 }}>
              <text fg={uiColors.textMuted} attributes={TextAttributes.BOLD}>Author: </text>
            ...
            {/* Source Branch */}
            <box style={{ flexDirection: 'row', paddingLeft: 1, paddingRight: 1 }}>
              <text fg={uiColors.textMuted} attributes={TextAttributes.BOLD}>Source: </text>
              <text fg={uiColors.textSecondary}>{mr().source_branch}</text>
            </box>

            {/* Target Branch */}
            <box style={{ flexDirection: 'row', paddingLeft: 1, paddingRight: 1 }}>
              <text fg={uiColors.textMuted} attributes={TextAttributes.BOLD}>Target: </text>
            ...
            <box style={{ flexDirection: 'row', paddingLeft: 1, paddingRight: 1 }}>
              ...
              <text fg={getStatusColor(mr().state)} attributes={TextAttributes.BOLD}>
                {mr().state}
              </text>
            </box>
            ...
            <Show when={mr().head_pipeline?.status}>
              {(status) => (
                <box style={{ flexDirection: 'row', paddingLeft: 1, paddingRight: 1 }}>
                  <text fg={uiColors.textMuted} attributes={TextAttributes.BOLD}>Pipeline: </text>
                  <text fg={getStatusColor(status())} attributes={TextAttributes.BOLD}>
                    {status()}
                  </text>
                </box>
              )}
            ...
            {/* Created */}
            <box style={{ flexDirection: 'row', paddingLeft: 1, paddingRight: 1 }}>
              <text fg={uiColors.textMuted} attributes={TextAttributes.BOLD}>Created: </text>
            ...
            {/* Updated */}
            <box style={{ flexDirection: 'row', paddingLeft: 1, paddingRight: 1 }}>
              <text fg={uiColors.textMuted} attributes={TextAttributes.BOLD}>Updated: </text>
              <text fg={uiColors.textSecondary}>
            ...
            <Show when={mr().description && mr().description.trim() !== ''}>
              <box style={{ marginTop: 1, paddingLeft: 1, paddingRight: 1 }}>
                <text fg={uiColors.textMuted} attributes={TextAttributes.BOLD}>Description:</text>
              </box>
            ...
            {/* URL */}
            <box style={{ marginTop: 1, flexDirection: 'row', paddingLeft: 1, paddingRight: 1 }}>
              <text fg={uiColors.textMuted} attributes={TextAttributes.BOLD}>URL: </text>
        ...
        >
          ...
          >
            ...
            <box style={{ height: 1, flexDirection: 'row', paddingLeft: 1, paddingRight: 1 }}>
              <text fg={uiColors.textMuted} attributes={TextAttributes.BOLD}>Merge: </text>
              <Show
            ...
            >
              <box style={{ height: 1, flexDirection: 'row', paddingLeft: 1, paddingRight: 1 }}>
                <text fg={uiColors.textMuted} attributes={TextAttributes.BOLD}>Details: </text>
                <text fg={uiColors.textSecondary}>
                  {mr().detailed_merge_status}
                </text>
              </box>
            ...
            <Show when={mr().draft || mr().work_in_progress}>
              <box style={{ height: 1, flexDirection: 'row', paddingLeft: 1, paddingRight: 1 }}>
                <text fg={uiColors.textMuted} attributes={TextAttributes.BOLD}>Draft: </text>
            ...
            <Show when={mr().has_conflicts}>
              <box style={{ height: 1, flexDirection: 'row', paddingLeft: 1, paddingRight: 1 }}>
                <text fg={uiColors.textMuted} attributes={TextAttributes.BOLD}>Conflicts: </text>
            ...
            <Show when={!mr().blocking_discussions_resolved}>
              <box style={{ height: 1, flexDirection: 'row', paddingLeft: 1, paddingRight: 1 }}>
                <text fg={uiColors.textMuted} attributes={TextAttributes.BOLD}>Discussions: </text>
            ...
            <Show when={mr().approvals}>
              <box style={{ height: 1, flexDirection: 'row', paddingLeft: 1, paddingRight: 1 }}>
                <text fg={uiColors.textMuted} attributes={TextAttributes.BOLD}>Approvals: </text>
                <Show
                  when={mr().approvals!.approvals_left === 0}
                  fallback={
                    <text fg={uiColors.warning}>
                      {mr().approvals!.approvals_required - mr().approvals!.approvals_left}/
                      {mr().approvals!.approvals_required} (need {mr().approvals!.approvals_left} more)
                    </text>
                  }
                >
              ...
              {/* Approved By */}
              <Show when={mr().approvals && mr().approvals!.approved_by?.length > 0}>
                <box style={{ height: 1, paddingLeft: 1, paddingRight: 1 }}>
                  <text fg={uiColors.textMuted} attributes={TextAttributes.BOLD}>Approved by:</text>
                </box>
            ...
            <Show when={mr().rebase_in_progress}>
              <box style={{ height: 1, flexDirection: 'row', paddingLeft: 1, paddingRight: 1 }}>
                <text fg={uiColors.textMuted} attributes={TextAttributes.BOLD}>Rebase: </text>
        ...
        >
          <box style={{ width: '100%', flexShrink: 0, flexDirection: 'column' }}>
            {/* Title */}
            <box 
            ...
            {/* Empty State */}
            <Show when={!props.changesLoading && !props.changesError && (!props.changes || props.changes.length === 0)}>
              <box 
                style={{ width: '100%', height: 1 }}
                paddingLeft={1}
                paddingRight={1}
      ...
      >
        ...
        >
          <box style={{ width: '100%', flexShrink: 0, flexDirection: 'column' }}>
            ...
            {/* Empty Jobs */}
            <Show when={!props.jobsLoading && mr().head_pipeline && mr().head_pipeline?.id && (!props.jobs || props.jobs.length === 0)}>
              <box 
                style={{ width: '100%', height: 1 }}
                paddingLeft={1}
                paddingRight={1}
          ...
          {/* Jobs by Stage */}
          <Show when={!props.jobsLoading && props.jobs && props.jobs.length > 0}>
            <scrollbox
              scrollbarOptions={SCROLLBAR_OPTIONS}
              style={{ flexGrow: 1, minHeight: 0 }}
            >
        ...
        >
          <box style={{ width: '100%', flexShrink: 0, flexDirection: 'column' }}>
            ...
            {/* No Discussions */}
            <Show when={!props.discussionsLoading && !props.discussionsError && discussionCounts().total === 0}>
              <box 
                style={{ width: '100%', height: 1 }}
                paddingLeft={1}
                paddingRight={1}
            ...
            {/* Discussion Summary */}
            <Show when={!props.discussionsLoading && discussionCounts().total > 0}>
              <box 
              ...
              <box style={{ width: '100%', height: 1, flexDirection: 'row' }}>
                <text fg={uiColors.textMuted} attributes={TextAttributes.BOLD}>Total: </text>
                <text fg={uiColors.textSecondary}>{discussionCounts().total}</text>
              </box>

              <box style={{ width: '100%', height: 1, flexDirection: 'row' }}>
                <text fg={uiColors.textMuted} attributes={TextAttributes.BOLD}>Open: </text>
                <text fg={discussionCounts().open > 0 ? uiColors.warning : uiColors.success}>
                  {discussionCounts().open}
                </text>
              </box>

              <box style={{ width: '100%', height: 1, flexDirection: 'row' }}>
                <text fg={uiColors.textMuted} attributes={TextAttributes.BOLD}>Resolved: </text>
                <text fg={uiColors.success}>{discussionCounts().resolved}</text>
              </box>
              </box>
            </Show>
          </box>
        ...
        >
          <box style={{ width: '100%', flexShrink: 0, flexDirection: 'column' }}>
            ...
            {/* No Tests */}
            <Show when={!props.testLoading && !props.testError && !props.testSummary}>
              <box 
                style={{ width: '100%', height: 1 }}
                paddingLeft={1}
                paddingRight={1}
            ...
            <Show when={!props.testLoading && props.testSummary}>
              ...
              <box style={{ width: '100%', height: 1, flexDirection: 'row' }}>
                <text fg={uiColors.textMuted} attributes={TextAttributes.BOLD}>Total: </text>
                <text fg={uiColors.textSecondary}>{props.testSummary!.total}</text>
              </box>

              <box style={{ width: '100%', height: 1, flexDirection: 'row' }}>
                <text fg={uiColors.textMuted} attributes={TextAttributes.BOLD}>Success: </text>
                <text fg={uiColors.success}>{props.testSummary!.success}</text>
              </box>

              <box style={{ width: '100%', height: 1, flexDirection: 'row' }}>
                <text fg={uiColors.textMuted} attributes={TextAttributes.BOLD}>Failed: </text>
                <text fg={uiColors.error}>{props.testSummary!.failed}</text>
              </box>

              <box style={{ width: '100%', height: 1, flexDirection: 'row' }}>
                <text fg={uiColors.textMuted} attributes={TextAttributes.BOLD}>Skipped: </text>
                <text fg={uiColors.textMuted}>{props.testSummary!.skipped}</text>
              </box>

              <Show when={props.testSummary!.error > 0}>
                <box style={{ width: '100%', height: 1, flexDirection: 'row', paddingBottom: 1 }}>
                  <text fg={uiColors.textMuted} attributes={TextAttributes.BOLD}>Error: </text>
