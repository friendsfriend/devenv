...
- `aiBackendPickerContext: Signal<'log-analysis' | 'new-agent-session' | null>` — which feature triggered the picker, used by the confirm handler to dispatch the correct action
